...
$sql = "SELECT * FROM jogadores WHERE torneio = 1 ";
    ...
    <main class="page-content">
        <div class="container">
            <div class="form-group col-md-12">
                <h3 class='titulo'> <i class="fas fa-angle-double-right" style='margin-right: 10px;'></i> Cadastrar Jogo Poker Regional </h3>
                <form method='POST' action='model/insereRegional.php'>
...
<div class='container'>
   <main class="page-content">
      <div class="container">
         <?php
            $sql = "SELECT * FROM nome_prt_regional ORDER BY Nome asc Limit 1";
            $resultado = mysqli_query($conexao, $sql);
            $lista = mysqli_fetch_assoc($resultado);
         ?>
         <form method='POST' action='model/insereNomeRegional.php'>
            <div class='row'>
               <div class="col-md-6">
...
<?php
include_once("../controller/conexaoPoker.php");
$sql = "SELECT * FROM vw_partidasregional ORDER BY Total DESC ";
$resultado = mysqli_query($conexao, $sql);
$posicao = 1;
function position($conexao)
{
    include_once("../controller/conexaoPoker.php");
    $sql = "SELECT * FROM vw_partidasregional";
    $resultado = mysqli_query($conexao, $sql);
