    ...
    <div class="container">
        <div class='row'>
            <div class="container-fluid">
                ...
                <?php
                include('../controller/conexaoPoker.php');
                $consulta = 'SELECT * FROM vw_partidas ';
                $resultado = mysqli_query($conexao, $consulta);
                ...
                <table class="table table-sm table-responsive">
                    <thead class="thead-dark">
                        <tr>
                            <td class='stlform' scope="col"><strong>Colocação Antiga</strong></td>
                            ...
                            <td class='stlform titleTabel' scope="col"><strong>Regional</strong></td>
                            <td class='stlform titleTabel' scope="col"><strong>JAN</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>FEV</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>MAR</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>ABR</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>MAI</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>JUN</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>JUL</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>AGO</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>SET</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>OUT</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>NOV</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>DEZ</strong>
                                <hr class='colocacao'>Pontos</td>
                            <td class='stlform titleTabel' scope="col"><strong>Bônus</strong></td>
                            <td class='stlform titleTabel' scope="col"><strong>Total</strong></td>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td><?php
                                    echo utf8_encode($row_poker['Regional']);
                                    ?></td>
                                <td class='resultTabel'><?php //echo $row_poker['PosicaoAtual']; 
                                                        ?> <?php echo $row_poker['Janeiro']; ?></td>
                                <td> <?php echo $row_poker['Fevereiro']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Março']; ?></td>
                                <td> <?php echo $row_poker['Abril']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Maio']; ?></td>
                                <td> <?php echo $row_poker['Junho']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Julho']; ?></td>
                                <td> <?php echo $row_poker['Agosto']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Setembro']; ?></td>
                                <td> <?php echo $row_poker['Outubro']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Novembro']; ?></td>
                                <td> <?php echo $row_poker['Dezembro']; ?></td>
                                <td class='resultTabel'> <?php echo $row_poker['Bonus']; ?></td>
                                <td style='background-color:beige'><strong><?php echo $row_poker['Total']; ?></strong></td>
                            <?php } ?>
                            </tr>
                    </thead>
                </table>
        ...
        <div class='row'>
            <div class='col-sm-6'>
                <div class='card-1'>
                    ...
                    <a href='pokerpresencial.php'><button class='btn btn.yellow'>Ver mais <i class="fas fa-plus"></i></button></a>
                </div>
            </div>
            <div class="col-sm-6">
                <div class='card-2'>
...
<style>
    ...
    .card-3 {
        ...
        border-radius: 10px;
        background:
            linear-gradient(rgba(0, 0, 0, 0.514), rgba(0, 0, 0, 0.63)),
            url("../images/card3.jpg") no-repeat;
        background-size: cover;
        margin: 20px;
